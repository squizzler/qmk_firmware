 ...
 * `----------------------------------'           `----------------------------------'
 *                  ,----------------------.    ,------,--------------.
 *                  |BKSP/GUI|  BAR |      |    |      |STROKE|Tab/GUI|
 *                  `---------------| Spc  |    | VOW  |------+-------.
 *                                  |      |    |      |
 *                                  `------'    `------'
 */
[_FORMS] = LAYOUT_split_3x5_3( \
  ...
  KC_ESC, KC_GRV,   KC_DOWN, KC_UP,  OSM(KC_LCTRL), OSM(KC_LALT), KC_LEFT, KC_RIGHT, KC_QUOT,  KC_ENT, \
           LGUI_T(KC_BSPC), MO(_BAR), KC_SPC,     TD(VOW_NOBAR), MO(_STROKE), LGUI_T(KC_TAB)              \
),
/* Const + bar
 *
 * ,----------------------------------.           ,----------------------------------.
...
[_BAR] = LAYOUT_split_3x5_3( \
  ...
  _______,    KC_P1,   KC_P2,   KC_P3,   _______,    _______,    _______,    _______, _______,  _______, \
                    _______, _______, _______,       TD(VOW_WITHBAR), _______, _______                 \
),
