...
[_RSTHD] = LAYOUT( \
    ...
    KC_SCLN,     KC_V,        KC_G,        KC_P,        KC_B,     KC_X,  KC_W,        XP(FULST, EXCLA),      KC_QUOT,      KC_SLSH, \
             KC_CAPS       ,SFT_T(KC_BSPC), LT(_RAISE, KC_E),     LT(_LOWER, KC_SPC), KC_TAB, TO(RAISE)    \
),

[_RAISE] = LAYOUT( \
  KC_CLR,    KC_AT,    KC_HASH, KC_DLR,  KC_PERC,       KC_PLUS,  KC_7,    KC_8,   KC_9,   KC_0,    \
  SFT_T(X(CIRCUM)),   KC_AMPR,  KC_TILD, KC_PIPE, KC_BSLS,      KC_MINS,  KC_4,    KC_5,   KC_6, SFT_T(KC_EQL), \
